...
urlpatterns = [
    ...
    url(r'^credit_mall/order/by_status/(?P<order_status>.+)/(?P<start_time>\d+)/(?P<end_time>\d+)/(?P<limit_num>\d+)$',
        credit_mall.get_orders),
    url(r'^credit_mall/order/by_status/(?P<order_status>.+)/(?P<end_time>\d+)/(?P<limit_num>\d+)$',
        credit_mall.get_orders),
    url(r'^credit_mall/order/by_status/(?P<order_status>.+)/(?P<limit_num>\d+)$',
        credit_mall.get_orders),
]
